  ...
  final List<Map<String, dynamic>> profileOptions = [
    {
      ...
      'title': 'Edit Profile',
      'route': '/editProfile', // Add your EditProfile route here
    },
    {
      'icon': 'assets/padlock.png',
      'title': 'Change Password',
      'route': '/changePassword', // Add your ChangePassword route here
    },
    {
    ...
    },
    {
      ...
      'route': '/privacyPolicy', // Add your PrivacyPolicy route here
    },
    {
      'icon': 'assets/terms.png',
      'title': 'Terms & Conditions',
      'route': '/terms', // Add your Terms route here
    },
    {
    ...
    try {
      ...
      if (userImageSnapshot.exists) {
        ...
        if (profileImageName != null && profileImageName.isNotEmpty) {
          ...
          setState(() {
            _profileImageUrl = downloadUrl; // Set the URL to be used for the image
          });
        }
      }
    } catch (e) {
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (option['title'] == 'Logout') {
                        _signOut();
                      } else if (option['route'] != null && option['route']!.isNotEmpty) {
